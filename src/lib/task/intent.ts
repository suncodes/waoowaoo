...
const TASK_INTENT_BY_TYPE: Record<TaskType, TaskIntent> = {
  ...
  [TASK_TYPE.CONTENT_PLAN_RUN]: 'build',
  [TASK_TYPE.VISUAL_PLAN_RUN]: 'build',
  [TASK_TYPE.VISUAL_QUALITY_REVIEW]: 'analyze',
  [TASK_TYPE.VISUAL_AUTO_REPAIR]: 'modify',
  ...
  [TASK_TYPE.DIAGNOSTIC_EXPORT]: 'process',
}
