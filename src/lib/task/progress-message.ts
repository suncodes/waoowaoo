...
const TASK_TYPE_LABELS: Record<string, string> = {
  ...
  [TASK_TYPE.VIDEO_MERGE_EXPORT]: 'progress.taskType.videoMergeExport',
  [TASK_TYPE.AUDIO_MIX]: 'progress.taskType.audioMix',
  ...
  [TASK_TYPE.CONTENT_PLAN_RUN]: 'progress.taskType.contentPlanRun',
  [TASK_TYPE.VISUAL_PLAN_RUN]: 'progress.taskType.visualPlanRun',
  [TASK_TYPE.VISUAL_QUALITY_REVIEW]: 'progress.taskType.visualQualityReview',
  [TASK_TYPE.VISUAL_AUTO_REPAIR]: 'progress.taskType.visualAutoRepair',
  ...
  [TASK_TYPE.DIAGNOSTIC_EXPORT]: 'progress.taskType.diagnosticExport',
}
...
const STAGE_LABELS: Record<string, string> = {
  ...
  merge_download: 'progress.stage.mergeDownload',
  ...
  audio_mix_upload: 'progress.stage.audioMixUpload',
  ...
  content_plan_prepare: 'progress.stage.contentPlanPrepare',
  content_plan_generate: 'progress.stage.contentPlanGenerate',
  content_plan_review: 'progress.stage.contentPlanReview',
  content_plan_persist: 'progress.stage.contentPlanPersist',
  visual_plan_prepare: 'progress.stage.visualPlanPrepare',
  visual_plan_generate: 'progress.stage.visualPlanGenerate',
  visual_plan_persist: 'progress.stage.visualPlanPersist',
  visual_quality_prepare: 'progress.stage.visualQualityPrepare',
  visual_quality_review: 'progress.stage.visualQualityReview',
  visual_quality_route: 'progress.stage.visualQualityRoute',
  visual_auto_repair_generate: 'progress.stage.visualAutoRepairGenerate',
  visual_auto_repair_persist: 'progress.stage.visualAutoRepairPersist',
