...
const LEGACY_STAGE_ROUTES: Record<string, Omit<CreationStageRoute, 'isAlias'>> = {
  ...
  'text-storyboard': { stageId: 'storyboard-preview', view: 'script' },
  storyboard: { stageId: 'storyboard-preview', view: 'script' },
  'storyboard-script': { stageId: 'storyboard-preview', view: 'script' },
  'storyboard-images': { stageId: 'storyboard-preview', view: 'images' },
