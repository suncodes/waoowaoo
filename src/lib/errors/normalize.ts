...
function inferCodeFromMessage(message: string): UnifiedErrorCode | null {
  ...
  if (containsAny(message, ['sensitive', 'unsafe', 'safety', 'blocked', 'prohibited', 'policy_violation', 'moderation', 'harm', 'copyright restrictions', 'related to copyright', 'copyright', '敏感', '违规', '不当', '版权', '安全策略', '被过滤']) && !containsAny(message, ['case-sensitive', 'case sensitive'])) return 'SENSITIVE_CONTENT'
