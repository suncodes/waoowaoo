...
export default function GlassModalShell({
  ...
  return createPortal(
    ...
    >
      ...
      />
      <div className={cx('glass-surface-modal relative z-10 flex max-h-[calc(100dvh-2rem)] w-full flex-col overflow-hidden sm:max-h-[calc(100dvh-3rem)]', maxWidthClass)}>
