...
describe('creation workspace stages', () => {
  ...
  it.each([
    ...
    ['text-storyboard', 'storyboard-preview', 'script'],
    ['storyboard', 'storyboard-preview', 'script'],
    ['storyboard-script', 'storyboard-preview', 'script'],
    ['storyboard-images', 'storyboard-preview', 'images'],
