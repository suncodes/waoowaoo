...
const TASK_TYPE_OWNER_MAP = {
  ...
  [TASK_TYPE.CONTENT_PLAN_RUN]: 'tests/unit/worker/content-plan.test.ts',
  [TASK_TYPE.VISUAL_PLAN_RUN]: 'tests/unit/worker/visual-plan.test.ts',
  [TASK_TYPE.VISUAL_QUALITY_REVIEW]: 'tests/unit/worker/visual-quality-review.test.ts',
  [TASK_TYPE.VISUAL_AUTO_REPAIR]: 'tests/unit/worker/visual-auto-repair.test.ts',
  ...
  [TASK_TYPE.DIAGNOSTIC_EXPORT]: 'tests/unit/worker/diagnostic-export.test.ts',
